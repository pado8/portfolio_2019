...
<head>
	...
	<title>sub8(글쓰기)</title>
	<link rel="stylesheet" href="/css/basic.css"/>
	<link rel="stylesheet" href="/css/common.css"/>
	<link rel="stylesheet" href="/sub8/css/substyle8.css"/>
						...
						<li class="smOneDepth"><a href="/sub2/sub2.jsp">신청 및 조회</a>
							<div class="smtwoInner">
								<ul class="smtwoDepth cf cf">
									...
									<li><a href="/sub8/sub8.jsp">정보공개청구</a></li>
			...
			<div id="mainRight">
				...
				<div id="noticeBorad">
					<div class="nbContent">
						...
						<div class="writeTit">
							<span>제목:</span><input type="text" name="title" value="${param.title}">
