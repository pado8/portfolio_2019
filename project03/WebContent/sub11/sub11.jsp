...
<head>
	...
	<title>sub11(글내용 수정)</title>
	<link rel="stylesheet" href="/css/basic.css"/>
	<link rel="stylesheet" href="/css/common.css"/>
	<link rel="stylesheet" href="/sub11/css/substyle11.css"/>
    <script src="/js/jquery-1.9.1.min.js"></script>
    <script src="/js/menu.js"></script>
    <script src="/js/quickmenu.js"></script>
    <script src="/js/subscript.js"></script>
    <script src="/sub11/js/script.js"></script>	
</head>
<body>
	<div id="wrap">
			...
			<div id="mainLeft">
				...
				<div class="leftsideMenu">
					<ul class="smOnedepthlist cf">
						<li class="smOneDepth"><a href="/sub1/sub1.jsp">종합안내</a>
							<div class="smtwoInner">
								<ul class="smtwoDepth cf cf">
									...
									<li><a href="/sub11/sub11.jsp">민원 봉사실</a></li>
						...
						<li class="smOneDepth"><a href="/sub4/sub4.jsp">민원 콜센터</a>
							<div class="smtwoInner">
								<ul class="smtwoDepth cf">
									<li><a href="/sub4/sub4.jsp">포항시 빨리콜(8282)</a></li>
									<li><a href="/sub4/sub4.jsp">110정부 민원안내 콜센터</a></li>
								</ul>
							</div>
						</li>
				...
				<div id="noticeBorad">
					<div class="nbContent">
						<form action="/article/modify.do" method="post">
							...
							<div class="writeTit">
								<span>제목:</span><input type="text" name="title" value="${modReq.title}">
