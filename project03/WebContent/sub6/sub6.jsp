...
<head>
	...
	<title>sub6(회원가입)</title>
	<link rel="stylesheet" href="/css/basic.css"/>
	<link rel="stylesheet" href="/css/common.css"/>
	<link rel="stylesheet" href="/sub6/css/substyle6.css"/>
    <script src="/js/jquery-1.9.1.min.js"></script>
    <script src="/js/menu.js"></script>
    <script src="/js/quickmenu.js"></script>
    <script src="/js/subscript.js"></script>
    <script src="/js/guide.js"></script>
    <script src="/sub6/js/script.js"></script>	
</head>
<body>
	<div id="wrap">
						...
						<li class="smOneDepth"><a href="/sub2/sub2.jsp">포항소식</a>
							<div class="smtwoInner">
								<ul class="smtwoDepth cf cf">
									...
									<li><a href="/sub6/sub6.jsp">행사·축제</a></li>
					...
					<div class="joinBox">
						...
						<div class="joinIp">
							<form action="/join.do" method="post">
								<div>
									<span>아이디:</span><input type="text" name="id" value="${param.id}">
									<c:if test="${errors.id}">ID를 입력하세요.</c:if>
									<c:if test="${errors.duplicateId}">이미 사용중인 아이디입니다.</c:if>
								</div>
								<div>
									<span>이름:</span><input type="text" name="name" value="${param.name}">
								...
								<div>
									<span>비밀번호 확인:</span><input type="password" name="confirmPassword" >
									<c:if test="${errors.confirmPassword}">확인을 입력하세요.</c:if>
									<c:if test="${errors.notMatch}">암호와 확인이 일치하지 않습니다.</c:if>
								</div>
								<div>
									<span>일반전화:</span><input type="text" name="homenum" class="homenum">
								</div>
								<div>
									<span>휴대전화:</span><input type="text" name="phonenum" class="phonenum">
								</div>
								<div>
									<span>이메일:</span><input type="text" name="email" class="email">
								</div>
								<div class="joinBtn">
