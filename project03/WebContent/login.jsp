...
<head>
	...
	<script> 
		...
		<style type="text/css">
			...
			.countertxt{color:#ffffff; font-size: 10px;}
			#counter{color:#ffffff; font-size: 10px;}
			.counterbtn{width: 23px; font-size: 10px;}
		</style>	
