...
<head>
	...
	<title>sub10(글내용 보기)</title>
	<link rel="stylesheet" href="/css/basic.css"/>
	<link rel="stylesheet" href="/css/common.css"/>
	<link rel="stylesheet" href="/sub10/css/substyle10.css"/>
    <script src="/js/jquery-1.9.1.min.js"></script>
    <script src="/js/menu.js"></script>
    <script src="/js/quickmenu.js"></script>
    <script src="/js/subscript.js"></script>
    <script src="/sub10/js/script.js"></script>	
</head>
<body>
	<div id="wrap">
		...
		<div id="mainVisual">
						...
						<li class="smOneDepth"><a href="/sub1/sub1.jsp">종합안내</a>
							<div class="smtwoInner">
								<ul class="smtwoDepth cf cf">
									...
									<li><a href="/sub10/sub10.jsp">현수막 지정게시판 접수</a></li>
			...
			<div id="mainRight">
				...
				<div id="noticeBorad">
					<div class="nbContent cf">
						<div class="numhd">
							<span>번호</span><p>${articleData.article.number}</p>
						</div>						
						<div class="topTit">
							<div class="writeTit fl">
								<span>제목</span>
								<p><c:out value='${articleData.article.title}' /></p>
							</div>	
							<div class="date fr">
								<span>날짜</span>
								<p><fmt:formatDate value="${articleData.article.regDate}" pattern="yyyy.MM.dd hh:mm" /></p>
							</div>	
							<div class="writer fr">
								<span>작성자</span>
								<p>${articleData.article.writer.name}</p>
							</div>
						</div>	
						<div class="contentArea cb">
							<p><u:pre value="${articleData.content }"/></p>
						</div>
						<div class="buttonWrap">
							<c:set var="pageNo" value="${empty param.pageNo ? '1' : param.pageNo }" />
								<div class="listBtn">
									<a href="/article/list.do?pageNo=${pageNo}"><input type="submit" value="글목록"></a>
								</div>		
							<c:if test="${authUser.id == articleData.article.writer.id}">							
								<div class="modBtn">
									<a href="/article/modify.do?no=${articleData.article.number}"><input type="submit" value="글수정"></a>
								</div>
								<div class="delBtn">
									<a href="/article/delete.do?no=${articleData.article.number}"><input type="submit" value="글삭제"></a>
								</div>
							</c:if>
						</div>					
					</div>
